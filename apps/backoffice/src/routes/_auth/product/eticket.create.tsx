/**
 * E-Ticket Product Create Page - 티켓 상품 등록 페이지
 */
...
export const Route = createFileRoute('/_auth/product/eticket/create')({
  component: CreateETicketProductPage,
});

function CreateETicketProductPage() {
  const navigate = useNavigate();

  const handleCancel = () => {
    navigate({ to: '/product/eticket' });
  };
    ...
    >
      ...
      <CardContent>
        <EmptyMessage>
          ...
          <EmptyTitle>티켓 상품 등록 폼 준비 중</EmptyTitle>
          <EmptyDescription>
            티켓 상품 등록 기능은 준비 중입니다.
          </EmptyDescription>
        </EmptyMessage>
      </CardContent>
    </MajorPageLayout>
