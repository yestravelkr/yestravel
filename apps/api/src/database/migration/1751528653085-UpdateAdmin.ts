...
export class UpdateAdmin1751528653085 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "admin"
      ADD "name" character varying(20) NOT NULL DEFAULT ''`);
    await queryRunner.query(`ALTER TABLE "admin"
      ADD "phone_number" character varying(20) NOT NULL DEFAULT ''`);
    await queryRunner.query(`ALTER TABLE "admin"
      ADD "role" "public"."admin_role_enum" NOT NULL DEFAULT 'ADMIN_STAFF'`);
    await queryRunner.query(`ALTER TABLE "admin"
      ADD "deleted_at" TIMESTAMP`);

    // 기존 컬럼 타입 변경
    await queryRunner.query(
      `ALTER TABLE "admin" ALTER COLUMN "email" TYPE character varying(50)`
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    // 컬럼 타입 원래대로 복구
    await queryRunner.query(
      `ALTER TABLE "admin" ALTER COLUMN "email" TYPE character varying`
    );
