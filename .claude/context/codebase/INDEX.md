...
| Partner App | 파트너 전용 프론트엔드 - 브랜드/인플루언서 로그인, 대시보드, 주문관리, TanStack Router + tRPC + Zustand | [partner-app.md](./partner-app.md) |
| Admin Shared | Backoffice/Partner 공유 UI 패키지 - 주문 관리 컴포넌트, Capabilities 패턴 권한 제어 | [admin-shared.md](./admin-shared.md) |
| Backoffice Auth | Admin/Partner 듀얼 JWT 인증, AllowRoles RBAC 데코레이터 | [backoffice-auth.md](./backoffice-auth.md) |
