...
const appRouter = t.router({
  ...
  partnerAccount: t.router({
    ...
    updateStaffRole: publicProcedure.input(z.object({ id: z.number(), role: z.enum(ROLE_ENUM_VALUE) })).output(z.object({
      id: z.number(),
      email: z.string(),
      role: roleEnumSchema,
    })).mutation(async () => "PLACEHOLDER_DO_NOT_REMOVE" as any),
  ...
  backofficeInfluencer: t.router({
    ...
    createManager: publicProcedure.input(z.object({
      email: z.string().email('이메일 형식이 아닙니다.'),
      password: z.string().min(8, '비밀번호는 최소 8자 이상이어야 합니다.'),
      name: z.string().min(1, '이름은 필수입니다.'),
      phoneNumber: z.string().min(1, '전화번호는 필수입니다.'),
    ...
    findManagers: publicProcedure.input(z.object({
      influencerId: z.number(),
    })).output(z.array(z.object({
      id: z.number(),
      email: z.string(),
  ...
  backofficeCampaign: t.router({
    ...
    create: publicProcedure.input(z.object({
      ...
      influencers: z.array(z.object({
        ...
        feeType: z.enum(['NONE', 'CUSTOM'] as const).default('NONE'),
  ...
  backofficeBrand: t.router({
    register: publicProcedure.input(z.object({
      ...
      brandManagers: z.array(z.object({
        id: z.number(),
        email: z.string(),
        name: z.string(),
        phoneNumber: z.string(),
